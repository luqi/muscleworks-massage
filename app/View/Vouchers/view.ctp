...
<div class="actions">
	...
	<ul>
	<li><?php echo $this->Html->link(__('BankTransfer'), array('action' => 'send_bankinstructions', $voucher['Voucher']['id'])); ?></li>
	</ul>
</div><div class="actions">
	<ul>
	<li><?php echo  $this->Html->link(__('Create Voucher'), array('action' => 'create_voucher1', $voucher['Voucher']['id'])); ?> </li>
	</ul>
</div>
...
<table cellpadding="0" cellspacing="0">
  ...
  <tr>
        <th width="300px">PaymentMethod</th>
        <th><?php echo $voucher['Voucher']['payment_method'] ?></th>
    </tr>
</table>
<br><br><br><br><br>