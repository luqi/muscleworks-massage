	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php if ($current_user['id'] == $user['User']['id'] || $current_user['role'] == 'admin'): ?>
			    <?php echo $this->Html->link('Edit User information', array('action' => 'edit', $user['User']['id'])); ?>
				<?php echo $this->Html->link('Change password', array('action' => 'changepassword', $user['User']['id'])); ?>
