...
(function($){
        ...
        function Carousel(root, options){
                ...
                this.move = function(iDirection, bPublic){
						...
						iCurrent_index = iCurrent;
						if (iCurrent == 0 && options.loop) {
							//iCurrent_index = 1;
							oContent.css('left', (iPageSize * options.display));
						}
                        if(iCurrent > -1 && iCurrent < iSteps){
                                var oPosition = {};
                                oPosition[bAxis ? 'left' : 'top'] = -(iCurrent_index * (iPageSize * options.display));       
